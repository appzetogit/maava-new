...
const OptimizedImage = ({
  ...
  // Callers pass whatever the API returned, and this backend often returns
  // an image as { url } rather than a string (profileImage, menuImages). The
  // preload effect below then called .startsWith on an object and threw
  // inside an effect, which unmounts the whole page. Normalise once here.
