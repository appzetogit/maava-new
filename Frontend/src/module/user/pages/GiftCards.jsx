          ...
          <Card className="border border-gray-100 dark:border-gray-800 shadow-sm bg-white dark:bg-[#1a1a1a]">
            <CardContent className="p-4 space-y-4">
              ...
              <div className="flex items-center gap-1 pt-1">
                ...
                <Link to="/food/user/gift-card/redeem" className="text-green-700 dark:text-green-400 text-sm font-medium underline underline-offset-2 decoration-dashed hover:text-green-800 dark:hover:text-green-500">
                  Redeem now
                </Link>
              </div>
            </CardContent>
